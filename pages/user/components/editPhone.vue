<template>
  <div>
    ...
    <div>
      ...
      <el-form
        v-if="defData.step === 1" ref="formRef" label-width="250px" :rules="rules" :model="form"
      ...
      >
        ...
        <el-form-item prop="vali_code" label="验证码：">
          <el-col :span="15">
            <el-input
              v-model.trim="form.vali_code" type="text" maxlength="4" placeholder="请输入验证码" clearable tabindex="3"
              @keyup.enter="onClick"
            />
          </el-col>
          <el-col :span="1" />
      ...
      <el-form
        v-else-if="defData.step === 2" ref="formRef" label-width="250px" :rules="rules" :model="form"
        style="max-width: 600px"
      >
        <el-form-item prop="password" label="新手机号：">
          <el-input v-model="form.password" placeholder="请输入新手机号" show-password />
        </el-form-item>
        <el-form-item prop="sms_code" label="短信验证码：">
          <el-col :span="15">
            <el-input v-model.trim="form.sms_code" type="text" placeholder="请输入短信验证码" clearable tabindex="3" />
