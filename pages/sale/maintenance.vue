            ...
            <el-row :gutter="10">
                ...
                <el-col :xs="24" :sm="20" :md="20" :lg="20" :xl="20">
                    <el-form-item label="详细地址" prop="address">
                        <el-input v-model="form.data.address" type="textarea" show-word-limit maxlength="200" clearable />
                    </el-form-item>
                </el-col>
                <!-- <el-col :xs="24" :sm="20" :md="20" :lg="20" :xl="20"> -->
                <el-form-item label="商品关键字" prop="goods_id">
                    <el-select v-model="form.data.goods_id" filterable remote reserve-keyword placeholder="请输入商品关键字"
                        style="width: 500px" :remote-method="remoteMethod" :loading="defData.loading" clearable>
