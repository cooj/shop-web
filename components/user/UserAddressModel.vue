...
<template>
  <!-- auto-height -->
  <BaseDialog
    v-model:visible="defData.visible" :loading="defData.btnLoading" auto-height hidden :title="comData.title"
      ...
      <el-row>
        ...
        <el-col :xs="24" :sm="20" :md="20" :lg="20" :xl="20">
          <el-form-item label="省市区：" prop="provinceArr">
            <el-cascader
              v-model="form.data.provinceArr" :options="defData.addressList"
