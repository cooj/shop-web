<template>
  <div class="upload-box" :class="`limit${props.limit}`">
    <el-upload
      v-if="props.type === 'text'" v-model:file-list="defData.uploadList" class="upload-text"
    ...
    <el-upload
      v-else v-model:file-list="defData.uploadList" :class="{ 'hide-upload': defData.hideUpload }" action="/"
    ...
    <el-image-viewer
      v-if="showImg.viewer" :url-list="showImg.list" :z-index="10000" :initial-index="showImg.index"
